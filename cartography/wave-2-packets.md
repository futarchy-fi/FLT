...
| hub-oig35.20 v2 (Torsion `DistribMulAction`) | ~~READY — dispatch, but re-declare~~ → **DONE — DO NOT DISPATCH** | ~~Holes live at `FLT/EllipticCurve/Torsion.lean:109–112`.~~ **Corrected 2026-08-17T21:29Z (fermat):** this row was stale the moment it was written — its own recorded base `b0fbbec` *is* the PR #8 merge that closed these four holes. Re-verified at `2994fd9`: `grep -n sorry FLT/EllipticCurve/Torsion.lean` → **46, 52, 57, 75, 132** (5 live) + prose 122; lines 109–112 hold the shipped `cases P <;> rfl` proof bodies. The delta `[-4,-4]` is unachievable — a worker dispatched here finds nothing to close and the packet fails or no-ops. Authoritative rows: `wave-3-packets.md` §2 line 153 and `oracle-recount.md` §2 line 156, both **DONE**. The line-114 prose / line-109 comment caution is likewise obsolete (prose moved to 122). |
