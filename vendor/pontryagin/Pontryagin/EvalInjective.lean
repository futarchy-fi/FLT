...
public import Pontryagin.Basic
public import Pontryagin.Inversion
...
theorem eq_one_of_forall_char_eq_one {z : G}
...
theorem exists_nhds_one_preimage_eval_subset {U : Set G} (hU : U ∈ nhds (1 : G)) :
