...
Let $(a,b,c,p)$ be a Frey package with $p\geq17$ (so in particular $p$ is prime and
$a^p+b^p=c^p$),
...
\begin{theorem}
  ...
  \leanok
  If $\overline{\rho}$ is the mod $p$ Galois representation associated to a Frey package
  $(a,b,c,p)$ with $p\geq17$, then
